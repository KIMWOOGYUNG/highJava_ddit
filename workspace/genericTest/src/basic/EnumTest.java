...
public class EnumTest {
	...
	//		==> 상수명을 따옴표로 묶지 않는다.
	//		==> 이 선언문 끝에 ';'를 붙이지 않는다.
	public enum City {서울, 부산, 대구, 광주, 대전} //상수는 따옴표를 묶지 않음
	
	//열거형 상수에 사용자가 임의의 값을 설정할 수 있다.
	//사용자가 설정할 임의의 값을 상수명 옆에 괄호 속에 저장한다.
	public enum Season{
		봄("3월부터 5월까지"),
		여름("6월부터 8월까지"),		
		가을("9월부터11월까지"),
		겨울("12월부터2까지"); //임의의 값이 설정된 상수를 선언할 때는 마지막에 세미콜론(;)을 붙인다.
		
		//임의의 값이 저장될 변수 선언
		private String span;
		
		//열거형의 생성자를 만든다. ==> 지정한 임의의 값을 변수에 셋팅하는 역할을 수행한다.
		//열거형의 생성자는 private 이어야 한다. (생략하면 기본적으로 private이 된다.)
	...
	public static void main(String[] args) {
		...
		System.out.println("city2 ordinal : " + city2.ordinal());
		System.out.println();
		...
		System.out.println("ss의 span : " + ss.span);
		System.out.println();
