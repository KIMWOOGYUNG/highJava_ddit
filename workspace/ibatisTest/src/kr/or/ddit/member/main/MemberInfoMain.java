...
public class MemberInfoMain {
	...
	public void memberSearch(){
		...
		case 4: fieldName = "mem_addr";
			break;
		default : 
			System.out.println("검색할 컬럼을 잘못 선택하셨습니다.");
		...
		printMember(memList);
		logger.info("검색할 객체 생성 후 프린트 메소드에 전달 완료");
	}
	
	//회원정보를 출력하는 공통 메서드
	public void printMember(List<MemberVO> memList){
		logger.info("회원정보 출력 시작...");
		System.out.println();
		System.out.println("--------------------------------");
	...
	public void memberDelete(){
		logger.info("회원 삭제 시작...");
		System.out.println();
		System.out.println("삭제할 회원 정보를 입력하세요.");
		System.out.print("삭제할 회원ID >> ");
		String memId = scan.next();
		logger.info("삭제할 회원ID 입력 완료...");
	...
	public void memberInsert(){
		logger.info("회원 추가 시작");
		System.out.println();
		System.out.println("추가할 회원 정보를 입력하세요.");
		
		System.out.print("회원ID >> ");
		String memId = scan.next();
		logger.info("추가할 회원아이디 입력 시작...");
		...
		logger.debug("추가할 회원아이디 중복검사 완료");
		...
		logger.debug("회원의 이름, 전화번호, 주소 입력");
		...
		if(cnt>0){
			...
			logger.debug("DB에 회원추가 완료...");
		}else{
			System.out.println("추가 작업 실패~~");
			logger.error("DB에 회원추가 실패...");
		}
