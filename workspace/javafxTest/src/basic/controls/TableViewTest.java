...
public class TableViewTest extends Application {
	...
	public void start(Stage primaryStage) {
		...
		ObservableList<Member> data = FXCollections.observableArrayList(
			new Member("김우경", "kwg", 26, "010-1111-1111", "대전"),
			new Member("이우경", "lwg", 26, "010-1111-1111", "서울"),
			new Member("박우경", "pwg", 26, "010-1111-1111", "제주"),
			new Member("최우경", "cwg", 26, "010-1111-1111", "원주")
		);
		*/
		//리스트의 값을 옵저버블리스트에 추가
		List<Member> memList = new ArrayList<Member>();
		memList.add(new Member("김우경", "kwg", 26, "010-1111-1111", "대전"));
		memList.add(new Member("이우경", "lwg", 26, "010-1111-1111", "서울"));
		memList.add(new Member("박우경", "pwg", 26, "010-1111-1111", "제주"));
		memList.add(new Member("최우경", "cwg", 26, "010-1111-1111", "원주"));
		...
		/*
		 * //방법1 TableView<Member> table = new TableView<Member>();
		 * table.setItems(data);
		 */
		//방법2
		...
		korNameCol.setCellValueFactory(
				//korName ==> Member객체 중 이 컬럼에 출력할 '멤버 변수명'
	...
	//삭제
		...
		btnTest.setOnAction(e -> {
			...
			//btnAdd.setDisable(true);	//추가버튼 사용불가
			//btnDel.setDisable(false);
			
			tfEngName.setPromptText("영어이름입력");	//입력전 흐릿하게 보여지는 내용
		});
