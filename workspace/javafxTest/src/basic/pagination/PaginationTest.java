...
public class PaginationTest extends Application {
	...
	//Pagination의 현재 선택된 index값을 매개값으로 받아서 
	//해당 페이지에 맞는 데이터를 가져와 Tableview에 넣어주는 메서드
	...
	public void changeTableView(int index) {
		...
		data = service.getPagingMemberList(pageMap);	//시작번호부터 끝번호 까지의 자료 가져오기
