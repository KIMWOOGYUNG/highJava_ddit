...
public class MainApplication {
    ...
    public static void main(String[] args) {
        ...
        list.add(new CustomerVo("kwg282", "김우경", "5", "kwg@naver.com"));
      ...
      //파일 읽어오기
         ...
         List<CustomerVo> xlsList = excelReader.xlsToCustomerVoList("C:\\excel\\testWrite.xls");
         printList(xlsList);
         
         System.out.println("*****xlsx*****");
         List<CustomerVo> xlsxList = excelReader.xlsxToCustomerVoList("C:\\excel\\testWrite.xlsx");
         printList(xlsxList);
